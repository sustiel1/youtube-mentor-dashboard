...
- [MACRO_SPECIALIZED_MAPPING_AUDIT.md](MACRO_SPECIALIZED_MAPPING_AUDIT.md) — closed audit+fix, referenced by `docs/workspace-session-handoff.md` Session D
...
- [SESSION_CLOSURE_NOTES_2026_07_01_HEBREW_MARKET_STATUS_LABELS.md](SESSION_CLOSURE_NOTES_2026_07_01_HEBREW_MARKET_STATUS_LABELS.md) — ⚠️ flagged as a duplicate of a file in `session-closures/`
- [workspace-session-handoff.md](workspace-session-handoff.md) — **live, multi-session tracker — contains real open items and unpushed-commit references; read before touching Workspace/Morning-Brief code**
- [workspace-session-handoff-delete-all.md](workspace-session-handoff-delete-all.md) — temporary handoff note, self-flagged for merging into the file above
