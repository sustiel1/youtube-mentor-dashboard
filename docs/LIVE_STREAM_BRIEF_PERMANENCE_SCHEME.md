...
- **הכרעת מימוש (Phase 2, 2026-08-30):** כאשר אף אחד מ‑6 השדות אינו סופק לפריט
  (המקרה הרגיל לכל שמירה שאינה מבזק ולכל קורא לפני חיווט Phase 3), שורת
  `ymd-meta` נשמטת לחלוטין ואינה נכתבת כשורת `-` גורפת.
