...
> ⚠️ **הוחלף כאינדקס תיעוד.** [docs/INDEX.md](INDEX.md) הוא כעת נקודת הכניסה הקנונית היחידה לתיעוד
> הפרויקט. קובץ זה לא נמחק ולא הועבר לארכיון — הוא נשמר ללא שינוי למטה לצורך הפניה היסטורית/ביקורת.
