...
export const SECTION_EDIT_COLUMNS = {
  ...
  macro: [
    ...
    { key: 'actualValue', label: 'בפועל' },
    { key: 'currentValue', label: 'נוכחי' },
    { key: 'value', label: 'ערך מדווח (ישן)' },
    { key: 'targetValue', label: 'יעד' },
    { key: 'referenceValue', label: 'ייחוס' },
    { key: 'forecastValue', label: 'תחזית' },
    { key: 'previousValue', label: 'קודם' },
    { key: 'change', label: 'שינוי' },
    { key: 'period', label: 'תקופה' },
    { key: 'gapToTarget', label: 'פער מהיעד' },
