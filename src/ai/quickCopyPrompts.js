...
export function buildGeminiNewsQuickPrompt({ title, duration, transcript }) {
  ...
  return [
    ...
    '• macro: שמור בנפרד actualValue/currentValue, targetValue/referenceValue, forecastValue, previousValue, change, period, meaning ו-gapToTarget',
    '• יעד האינפלציה 2% של הפד אינו ערך CPI נוכחי; אסור להסיק תפקיד מספרי מטקסט סמוך או להמציא מקור/URL',
