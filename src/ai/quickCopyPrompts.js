...
export function buildGeminiNewsQuickPrompt({ title, duration, transcript }) {
  ...
  return [
    ...
    '• החזר את תוכן הניתוח רק בתוך universalTabs לפי הסכמה. אל תשכפל shortSummary, fullSummary, chapters או שדות specialized כשדות legacy ברמת השורש',
    ...
    '• חובה לשים פסיק בין כל שני שדות סמוכים ובין כל שני פריטים סמוכים במערך; אין להשמיט פסיקים נדרשים.',
