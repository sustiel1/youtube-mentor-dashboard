...
export function buildPoliticalAnalysisPrompt({
  ...
  return [
    ...
    'כל פרק חייב לכלול כותרת ספציפית ו-summary. startSeconds ו-endSeconds יכולים להיות null.',
    ...
    'זמני פרקים מותרים רק כאשר הם מופיעים במפורש בתמלול או ברמזי YouTube. אחרת החזר startSeconds: null, endSeconds: null, timestampSource: unavailable; לעולם אל תעריך זמן לפי סדר הטקסט או משך הסרטון.',
