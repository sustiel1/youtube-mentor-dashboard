...
export function WorkspaceVideoGroupCard({ group, topics, selectedIds, onToggleItem, onToggleGroup, onOpenVideo, onOpenItem, onEditItem, onArchiveItem, onDeleteItem, onToggleItemFlag, focusItemId, onFocusVideo, isFocused = false, videoLookup }) {
