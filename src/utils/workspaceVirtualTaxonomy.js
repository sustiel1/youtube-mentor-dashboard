...
export const VIRTUAL_TAXONOMY = [
  {
    ...
    subtopics: [
      ...
      { id: 'vts-fundamental', name: 'פונדמנטלי',      realTopicIds: ['wt-markets-fundamental', 'wt-fundamental'] },
      { id: 'vts-technical', name: 'טכני',             realTopicIds: ['wt-technical', 'wt-technical-sr', 'wt-technical-trend', 'wt-technical-ma', 'wt-technical-rsi', 'wt-technical-macd', 'wt-technical-volume', 'wt-technical-entry', 'wt-markets-technical'] },
